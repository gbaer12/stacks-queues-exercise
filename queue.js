...
class Queue {
  ...
  /** enqueue(val):
   * add new value to end of the queue. Returns undefined.
   */
  ...
  /** dequeue():
   * remove the node from the start of the queue and return its value.  Should throw an error if the queue is empty.
   */
